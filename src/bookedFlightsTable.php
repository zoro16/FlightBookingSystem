...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="container" style="margin-top:0px;">
            ...
            <h2>Show Booked Flight Table</h2>
            <hr>
            <div class="table-responsive">          
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $stmt = $conn->query("SELECT * FROM booking INNER JOIN flights ON booking.flightID=flights.flightID ");
                        $stmt->execute();
                        ...
                        if ($stmt->rowCount() > 0) {
                            while($data = $stmt->fetch( PDO::FETCH_ASSOC )){ 
                                print " <tr> <td>". $data['bookingID']."</td> <td>". $data['cusFullName']."</td> <td>". $data['cusCitizenship']."</td> <td>". $data['cusPassportNo']."</td> <td>". $data['cusPhoneNo']."</td> 
                                  <td>". $data['current']."</td>
