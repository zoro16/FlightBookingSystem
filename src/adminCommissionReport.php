            ...
            <div class="table-responsive">          
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $stmt = $conn->query('SELECT bookingID,users.user_name, booking.user_id , SUM(commission) AS Commission, COUNT(bookingID) AS TicketsCount FROM booking INNER JOIN users ON booking.user_id=users.user_id  GROUP BY  booking.user_id ' );
                        $stmt->execute();
